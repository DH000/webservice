 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://service.umws.lin.com/", wsdlLocation = "file:/usr/local/codes/java/umws/src/main/webapp/WEB-INF/wsdl/user-doc.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://service.umws.lin.com/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/usr/local/codes/java/umws/src/main/webapp/WEB-INF/wsdl/user-doc.wsdl");
    ...
    public IUserService getUserServicePort() {
        return super.getPort(new QName("http://service.umws.lin.com/", "UserServicePort"), IUserService.class);
    }
    ...
    public IUserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.umws.lin.com/", "UserServicePort"), IUserService.class, features);
    }
