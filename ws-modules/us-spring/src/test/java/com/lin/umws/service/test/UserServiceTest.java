package com.lin.umws.service.test;
...
//		Endpoint.publish("http://localhost:8888/us", new UserServiceImpl());
		new UserServiceTest().loginTest();
	}
	
	@Test
	public void addTest(){
		try {
			Service service = Service.create(new URL("http://localhost:8888/ws/us"), new QName("http://service.umws.lin.com/", "UserService", "ns"));
