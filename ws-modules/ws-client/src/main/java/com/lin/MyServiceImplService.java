 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://impl.service.webservice.lin.com/", wsdlLocation = "http://localhost:8888/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.webservice.lin.com/", "MyServiceImplService");
    ...
    public MyService getMyServiceImplPort() {
        return super.getPort(new QName("http://impl.service.webservice.lin.com/", "MyServiceImplPort"), MyService.class);
    }
    ...
    public MyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.webservice.lin.com/", "MyServiceImplPort"), MyService.class, features);
    }
